...
<nav class="navbar navbar navbar-fixed-top" role="navigation">
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<c:url value="index.html"/>"> <img class="logo1" src="<c:url value="../../images/Logo.png"/>">alt=""></a>
            <a class="navbar-brand " href="<c:url value="index.html"/>">Cover to Cover</a>
        </div>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li >
                    <a href="<c:url value="account.html"/>">Account</a>
                </li>
                <li >
                    <a href="<c:url value="shoppingCart.html"/>">Book Bag</a>
                </li>
                <li class="login-button pull-right">
                    <a href="<c:url value="signOnPage.html"/>">Login / Register</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
