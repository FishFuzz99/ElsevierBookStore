/**
 * Created by DUNAWATL on 7/26/2016.
 */
flood=function() {
    document.getElementById("firstName").value = document.getElementById("firstName1").value
    document.getElementById("surname").value = document.getElementById("firstName1").value
    document.getElementById("StShipAddress").value = document.getElementById("StBillAddress").value
